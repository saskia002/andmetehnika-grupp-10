...
SELECT
    ...
    CAST(COALESCE(open_price, 0.0) AS Float64) AS OpenPrice,
    CAST(COALESCE(close_price, 0.0) AS Float64) AS ClosePrice,
    CAST(COALESCE(high_price, 0.0) AS Float64) AS HighPrice,
    CAST(COALESCE(low_price, 0.0) AS Float64) AS LowPrice,
    CAST(COALESCE(market_cap, 0) AS Float64) AS MarketCap,
    CAST(COALESCE(dividend, 0.0) AS Float64) AS Dividend
